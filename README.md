...
The PHP version of WhichBrowser for use on a server. Fully compatible with PHP 7.4 or higher, including PHP 8.
...
WhichBrowser requires with PHP 7.4 or higher and supports PHP 8. WhichBrowser is compatible with the PSR-4 autoloading standard and follows PSR-1 and PSR-2 coding style.
