...
Applications::$BROWSERS = [
    ...
    Constants\BrowserType::BROWSER => [
        ...
        [ 'name' => 'Arctic Fox',                'id' => 'arcticfox',     'regexp' => '/ArcticFox\/([0-9.]*)/u', 'type' => Constants\DeviceType::DESKTOP ],
        ...
        [ 'name' => 'Avast Secure',              'id' => 'aventsec',      'regexp' => '/ Secure\/([0-9.]*)/u', 'type' => Constants\DeviceType::DESKTOP ],
        ...
        [ 'name' => 'Classilla Browser',         'id' => 'classilla',     'regexp' => '/Classilla\/([0-9.A-Z]*)/u', 'details' => 3, 'type' => Constants\DeviceType::DESKTOP ],
        ...
        [ 'name' => 'Headless Chrome',           'id' => 'headless',      'regexp' => '/HeadlessChrome\/([0-9.]*)/u', 'type' => Constants\DeviceType::DESKTOP ],
        ...
        [ 'name' => 'ICE Browser',               'id' => 'icebrow',       'regexp' => '/ICE browser\/v?([0-9.]*)/i', 'type' => Constants\DeviceType::DESKTOP ],
        ...
        [ 'name' => 'LieYing',                   'id' => 'lieyang',       'regexp' => '/LieYing\/([0-9.]*)/u', 'type' => Constants\DeviceType::DESKTOP ],
        ...
        [ 'name' => 'NTENT Browser',             'id' => 'ntent',         'regexp' => '/NTENTBrowser\/([0-9.]*)/u' ],
        ...
        [ 'name' => 'OmniWeb',                   'id' => 'omniweb',       'regexp' => '/OmniWeb\/v([0-9.]*)/u', 'type' => Constants\DeviceType::DESKTOP ],
        ...
        [ 'name' => 'SeaMonkey',                 'id' => 'seamonkey',     'regexp' => '/SeaMonkey\/([0-9ab.]*)/i', 'type' => Constants\DeviceType::DESKTOP ],
        [ 'name' => 'Seznam Browser',            'id' => 'seznamapp',     'regexp' => '/SznProhlizec\/([0-9.]*)/u' ],
        ...
        [ 'name' => 'Sunrise Browser',           'id' => 'sunrise',       'regexp' => '/ Sunrise\/([0-9.]*)/u', 'type' => Constants\DeviceType::DESKTOP ],
        [ 'name' => 'Sunrise Browser',           'id' => 'sunrise',       'regexp' => '/SunriseBrowser\/([0-9.]*)/u', 'type' => Constants\DeviceType::DESKTOP ],
        ...
        [ 'name' => 'UR Browser',                'id' => 'ur',            'regexp' => '/ UR Browser\/([0-9.]*)/u', 'type' => Constants\DeviceType::DESKTOP ],
        [ 'name' => 'UR Browser',                'id' => 'ur',            'regexp' => '/ UR\/([0-9.]*)/u', 'type' => Constants\DeviceType::DESKTOP ],
        ...
        [ 'name' => 'Start Internet',            'id' => 'startbrowser',  'regexp' => '/ Start\/([0-9.]*)/u', 'type' => Constants\DeviceType::MOBILE ],
        ...
        [ 'name' => 'Freebox Browser',           'id' => 'freebox',       'regexp' => '/ Navigateur web\/([0-9.]*)/u', 'type' => Constants\DeviceType::TELEVISION ],
