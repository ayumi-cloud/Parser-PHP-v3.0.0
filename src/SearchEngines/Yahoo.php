...
class Yahoo
{
    ...
    public function __construct($ua)
    {
        ...
        if (preg_match('/(Nutch|siteexplorer|Slingstone|MMAudVid|Mindset|SiteChecker|MSIE\s(2|3|4|5|6|7|8|9|10)|Yahoo(FeedSeeker|YSMcm|VideoSearch)|Yahoo\sPipes|Yahoo\s?Bot|Slurp\;http)/iu', $ua, $match)) {
